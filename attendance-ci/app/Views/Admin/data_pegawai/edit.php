...
<div class="card col-md-6">
    ...
    <div class="input-style-1">
        <label for="inputText" class="col-form-label">ID Pegawai</label>
            <div class="col-sm-10">
                <input type="text" class="form-control <?= ($validation->hasError('nip')) ? 'is-invalid' : '' ?>" placeholder="ID Pegawai" name="nip" value="<?= $pegawai['nip'] ?>" id="inputText" >
    ...
    <div class="input-style-1">
        <label for="inputText" class="col-form-label">Nama</label>
            <div class="col-sm-10">
                <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : '' ?>" placeholder="Nama" name="nama" value="<?= $pegawai['nama'] ?>" id="inputText" >
    ...
    <div class="col-sm-10">
        <textarea class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : '' ?>" 
                  placeholder="Alamat" 
                  name="alamat"
                  id="inputText"> <?= $pegawai['alamat'] ?> </textarea>
    ...
    <div class="input-style-1">
        <label for="inputText" class="col-form-label">No.Handpone</label>
            <div class="col-sm-10">
                <input type="text" class="form-control <?= ($validation->hasError('no_handphone')) ? 'is-invalid' : '' ?>" placeholder="No Handpone" name="no_handphone" value="<?= $pegawai['no_handphone'] ?>" id="inputText" >
    ...
    <div class="input-style-1">
        <label for="inputText" class="col-form-label">Foto</label>
            <div class="col-sm-10">
                <input type="text" value="<?= $pegawai['foto'] ?>" name="foto_lama" hidden>
    ...
    <div class="input-style-1">
        <label for="inputText" class="col-form-label">Tanggal Lahir</label>
            <div class="col-sm-10">
                <input type="date" class="form-control <?= ($validation->hasError('tanggal_lahir')) ? 'is-invalid' : '' ?>" name="tanggal_lahir" value="<?= $pegawai['tanggal_lahir'] ?>" id="inputText" >
    ...
    <div class="input-style-1">
        <label for="inputText" class="col-form-label">Tanggal Masuk</label>
            <div class="col-sm-10">
                <input type="date" class="form-control <?= ($validation->hasError('tanggal_masuk')) ? 'is-invalid' : '' ?>" name="tanggal_masuk" value="<?= $pegawai['tanggal_masuk'] ?>" id="inputText" >
    ...
    <div class="col-sm-10">
        ...
        <option value="<?= $pegawai['clock_in_out_location']?>"><?= $pegawai['clock_in_out_location']?></option>
    ...
    <div class="input-style-1">
        <label for="inputText" class="col-form-label">Username</label>
            <div class="col-sm-10">
                <input type="username" class="form-control <?= ($validation->hasError('username')) ? 'is-invalid' : '' ?>" placeholder="Username" value="<?= $pegawai['username']?>" name="username" id="inputText" >
    ...
    <div class="input-style-1">
        <label for="inputText" class="col-form-label">Password</label>
            <div class="col-sm-10">
            <input type="text" value="<?= $pegawai['password'] ?>" name="password_lama" hidden>
    ...
    <div class="input-style-1">
        <label for="inputText" class="col-form-label">Konfirmasi Password</label>
            <div class="col-sm-10">
            <input type="text" value="<?= $pegawai['password'] ?>" name="konfirmasi_password_lama" hidden>
