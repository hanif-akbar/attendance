...
class Ketidakhadiran extends BaseController
{
    ...
    public function create(){
        ...
        return view('pegawai/ketidakhadiran/create_ketidakhadiran', $data);
    }
    ...
    public function store()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            echo view ('/pegawai/ketidakhadiran/create_ketidakhadiran',$data);
        }else{
            $ketidahadiranModel = new KetidakhadiranModel();
    ...
    public function edit($id){
        ...
        return view('Pegawai/ketidakhadiran/edit_ketidakhadiran', $data);
    }
