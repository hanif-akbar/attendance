        ...
        Webcam.snap(function(data_uri) {
            ...
            xhr.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    window.location.href = "<?= base_url('pegawai/dashboard') ?>"; // Fixed typo in window
                }
            };
            
            xhr.open("POST", "<?= base_url('pegawai/presensi_keluar_aksi/' . $id_presensi) ?>", true); // Fixed PHP tag
