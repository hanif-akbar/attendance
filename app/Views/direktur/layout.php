...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?= base_url('direktur/ubah_username') ?>">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?= base_url('direktur/ubah_password') ?>">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?= base_url('direktur/dashboard')?>">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= base_url('direktur/rekap_presensi') ?>">
              <i class="bi bi-circle"></i><span>Rekap Presensi</span>
            </a>
          </li>
          <li>
            <a href="<?= base_url('direktur/ketidakhadiran') ?>">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?= base_url('direktur/dashboard') ?>">Direktur</a></li>
