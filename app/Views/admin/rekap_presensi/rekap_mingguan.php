...
<form class="row g-3">
  <div class="col-auto">
    <input type="week" class="form-control" name="filter_mingguan"
      value="<?= isset($_GET['filter_mingguan']) ? $_GET['filter_mingguan'] : date('o-\WW') ?>"
      id="filter_mingguan">
  </div>
  <div class="col-auto">
  ...
  <div class="col-auto">
    <button type="submit" name="export_excel_mingguan" class="btn btn-success mb-3">Export Excel</button>
  </div>
</form>
...
<table class = "table table-striped table-bordered">
    ...
    <?php if ($rekap_mingguan) : ?>
    <?php $no=1; foreach ($rekap_mingguan as $rekap) : ?>
        <?php
